...
To visit this shinyApp's full webpage, click [here](https://ogf9uhy.shinyapps.io/SexEdContentRequirements).
...
waffle_data <- waffle_iron(icon_plot_data, aes_d(group = state), rows = 5) %>% mutate(label = ifelse(icon_plot_data$state == "inclusive", "rainbow.png", "grey circle.png"))
