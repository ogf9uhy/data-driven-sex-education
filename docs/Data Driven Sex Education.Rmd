...
teen_birth_rates<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/CDC Health Data - Teen Birth Rate 2023-March 2024.csv", header=TRUE)
aids_hiv_sti_rates2021<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/AIDS, HIV, and STI Rates 2021 - AIDS, HIV and STI Rates 2021.csv", header=TRUE)
sex_ed_levels<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Sex Education Level Data - Sex Education Level Data.csv", header=TRUE)
general_requirements<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/General Requirements for Sex Ed.csv", header=TRUE)
content_requirements<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Content Requirements for Sex Ed - Content Requirements for Sex Ed.csv", header=TRUE)
sex_ed_funding<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Sex Ed Funding by State - 2022 Sex Ed Funding.csv", header=TRUE)
hiv_sti_data<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/sti_hiv_data.csv")
...
funding_plot <- plot_ly(pie_data)%>%
  ...
  layout(title = list(text="Sex Education Federal Program Funding", y=0.9),
        images = list(
      source = base64enc::dataURI(file = "/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Screen Shot 2024-04-23 at 9.40.57 AM.png"),
      x = 0.8, y = 0.8, 
      sizex = 0.3, sizey = 0.2,
...
shinyapp: https://ogf9uhy.shinyapps.io/AdolescentPregnancyRate/

![](/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Screen Shot 2024-04-23 at 10.28.50 PM.png){ width=75% } ![](/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Screen Shot 2024-04-23 at 10.28.59 PM.png){ width=75% }
...
shinyapp: https://ogf9uhy.shinyapps.io/SexEdContentRequirements

![](/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Screen Shot 2024-04-23 at 10.29.12 PM.png){ width=75% }
![](/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Screen Shot 2024-04-23 at 10.29.20 PM.png){ width=75% }
![](/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/Screen Shot 2024-04-23 at 10.29.31 PM.png){ width=75% }
...
levels_by_region<-read.csv("/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/median_responses_region.csv")
...
waffle_data <- waffle_iron(icon_plot_data, aes_d(group = state), rows = 5) %>% mutate(label = ifelse(icon_plot_data$state == "inclusive", "/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/rainbow.png", "/Users/oliviafountain/Desktop/STAT 3280/Final Project Files/grey_vector.png"))
...
icon_array<-ggplot(waffle_data, aes(x, y)) + 
  ...
  labs(x = "", y = "", title = "Only 11 in 50 States Have Endorsed the Inclusion of Sexual Orientation Education") +
    theme(plot.title = element_text(size = 10, hjust=0.5))
icon_array
```
